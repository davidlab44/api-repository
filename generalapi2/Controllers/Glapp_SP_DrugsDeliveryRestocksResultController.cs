...
namespace generalapi2.Controllers
{
    ...
    public class Glapp_SP_DrugsDeliveryRestocksResultController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Glapp_SP_DrugsDeliveryRestocksResult>>> Glapp_SP_DrugsDeliveryRestocksResult(string P_User,string P_RestockID, string P_View)
        {
            ...
            return _context.Glapp_SP_DrugsDeliveryRestocksResult
                  ...
                  .FromSqlRaw($"exec Glapp_SP_DrugsDeliveryRestocks '{P_User}',{P_RestockID},'{P_View}'")
                  .ToList();
        }
