...
namespace generalapi.Controllers
{
    ...
    public class APP_SP_DrugsDeliveryConsumerViewArticlesResultController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<APP_SP_DrugsDeliveryConsumerViewArticlesResult>>> GetAPP_SP_DrugsDeliveryConsumerViewArticlesResult(string P_ConsumerUser)
        {
          if (_context.APP_SP_DrugsDeliveryConsumerViewArticlesResult == null)
          {
            ...
            return _context.APP_SP_DrugsDeliveryConsumerViewArticlesResult
                  .FromSqlRaw($"exec APP_SP_DrugsDeliveryConsumerViewArticles '{P_ConsumerUser}'")
                  .ToList();
        }
