...
namespace generalapi.Controllers
{
    ...
    public class APP_SP_DrugsDeliveryConsumerViewHeaderResultController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<APP_SP_DrugsDeliveryConsumerViewHeaderResult>>> GetAPP_SP_DrugsDeliveryConsumerViewHeaderResult(string P_ConsumerUser)
        {
          if (_context.APP_SP_DrugsDeliveryConsumerViewHeaderResult == null)
          {
            ...
            return _context.APP_SP_DrugsDeliveryConsumerViewHeaderResult
                  .FromSqlRaw($"exec APP_SP_DrugsDeliveryConsumerViewHeader '{P_ConsumerUser}'")
                  .ToList();
